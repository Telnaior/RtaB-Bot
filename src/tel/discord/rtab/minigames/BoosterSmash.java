...
public class BoosterSmash implements MiniGame {
	...
	{
		return quit || tokensPicked == -1;
	}

	@Override
	public int getMoneyWon()
	{
		if(quit || bailChance) //If they timed out when they had the chance to stop, just treat it as a stop
			return convertTokensToBoost(tokensPicked);
		else
			return -1;
	}
